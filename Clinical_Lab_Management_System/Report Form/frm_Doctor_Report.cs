...
{
    public partial class frm_Doctor_Report : Form
    {
        public frm_Doctor_Report()
        {
            InitializeComponent();
        }
        ...
        private void btn_ShowReport_Click(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(@"D:\Clinical_Lab_Management_System\Clinical_Lab_Management_System\Project Reports\Doctor_CrystalReport1.rpt");
